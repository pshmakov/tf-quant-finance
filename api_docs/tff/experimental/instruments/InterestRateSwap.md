...
<meta itemprop="name" content="tff.experimental.instruments.InterestRateSwap" />
...
# tff.experimental.instruments.InterestRateSwap
...
* <b>`receive_leg`</b>: A list of either `FixedCouponSpecs` or `FloatCouponSpecs`
  ...
  length of the list should be the same as the number of instruments
  being created.
* <b>`holiday_calendar`</b>: An instance of <a href="../../../tff/experimental/dates/HolidayCalendar.md"><code>dates.HolidayCalendar</code></a> to specify
