...
<meta itemprop="name" content="tff.experimental.dates.HolidayCalendar2" />
...
# tff.experimental.dates.HolidayCalendar2
...
* <b>`holidays`</b>: Defines the holidays that are added to the weekends defined by
  `weekend_mask`. An instance of <a href="../../../tff/experimental/dates/DateTensor.md"><code>dates.DateTensor</code></a> or an object
...
add_business_days(
    ...
    roll_convention=tff.experimental.dates.BusinessDayConvention.NONE
)
```
