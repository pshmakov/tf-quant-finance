...
<meta itemprop="name" content="tff.models.hull_white.HullWhiteModel1F" />
...
Inherits From: [`VectorHullWhiteModel`](../../../tff/models/hull_white/VectorHullWhiteModel.md)

```python
tff.models.hull_white.HullWhiteModel1F(
    mean_reversion, volatility, instant_forward_rate_fn, dtype=None, name=None
)
```
...
* <b>`mean_reversion`</b>: A real positive `Tensor` of shape `[1]` or a Python
